...
#' parameters following Case 27 and employing a sampling resolution of
#' \code{0.1 mm}, \code{0.2 mm}, \code{0.45 mm}, \code{0.75 mm}, \code{1.55 mm}
#' and \code{3.25 mm}.
#' 
#' Case 27 describes an ideal temperature sinusoid without distortion by either
#' changes in growth rate or changes in \eqn{\delta^{18}O_{w}}{δ18Ow} but with a
#' shorter (3 yr) record length.
#' 
#' Generated using the code in "Generate_Case27.r" in \code{data–raw}
#'
