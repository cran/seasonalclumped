...
#' parameters following Case 5 and employing a sampling resolution of
#' \code{0.1 mm}, \code{0.2 mm}, \code{0.45 mm}, \code{0.75 mm}, \code{1.55 mm}
#' and \code{3.25 mm}.
#' 
#' Case 5 describes an ideal temperature sinusoid without distortion by changes
#' in \eqn{\delta^{18}O_{w}}{δ18Ow}, but with seasonal variability in growth
#' rate which is in phase with the temperature seasonality.
#' 
#' Generated using the code in "Generate_Case5.r" in \code{data–raw}
#'
