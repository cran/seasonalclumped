...
#' parameters following Case 25 and employing a sampling resolution of
#' \code{0.1 mm}, \code{0.2 mm}, \code{0.45 mm}, \code{0.75 mm}, \code{1.55 mm}
#' and \code{3.25 mm}.
#' 
#' Case 25 describes an natural environment with temperature and
#'  \eqn{\delta^{18}O_{w}}{δ18Ow} records from a high–latitude marine site (Iceland).
#' data from \code{inst/extdata/Iceland_data.csv}.
#' 
#' Generated using the code in "Generate_Case25.r" in \code{data–raw}
#'
