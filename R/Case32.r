...
#' parameters following Case 32 and employing a sampling resolution of
#' \code{0.1 mm}, \code{0.2 mm}, \code{0.45 mm}, \code{0.75 mm}, \code{1.55 mm}
#' and \code{3.25 mm}.
#' 
#' Case 32 describes an ideal temperature sinusoid without distortion by changes
#' in growth rate, but with seasonal variability in \eqn{\delta^{18}O_{w}}{δ18Ow}
#' with a minimum in spring season and a large (45 days SD) error on age model
#' (roughly +/– three months)
#' 
#' Generated using the code in "Generate_Case32.r" in \code{data–raw}
#'
