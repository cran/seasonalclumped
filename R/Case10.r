...
#' parameters following Case 10 and employing a sampling resolution of
#' \code{0.1 mm}, \code{0.2 mm}, \code{0.45 mm}, \code{0.75 mm}, \code{1.55 mm}
#' and \code{3.25 mm}.
#' 
#' Case 10 describes an ideal temperature sinusoid without distortion by changes
#' in growth rate, but a negative peak in \eqn{\delta^{18}O_{w}}{δ18Ow}
#' during spring season.
#' 
#' Generated using the code in "Generate_Case10.r" in \code{data–raw}
#'
