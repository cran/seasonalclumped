...
#' parameters following Case 11 and employing a sampling resolution of
#' \code{0.1 mm}, \code{0.2 mm}, \code{0.45 mm}, \code{0.75 mm}, \code{1.55 mm}
#' and \code{3.25 mm}.
#' 
#' Case 11 describes an ideal temperature sinusoid without distortion by changes
#' in growth rate, but a positive peak in \eqn{\delta^{18}O_{w}}{δ18Ow} during
#' the warm season.
#' 
#' Generated using the code in "Generate_Case11.r" in \code{data–raw}
#'
