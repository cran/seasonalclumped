...
#' parameters following Case 12 and employing a sampling resolution of
#' \code{0.1 mm}, \code{0.2 mm}, \code{0.45 mm}, \code{0.75 mm}, \code{1.55 mm}
#' and \code{3.25 mm}.
#' 
#' Case 12 describes a temperature sinusoid without distortion by changes
#' in growth rate or \eqn{\delta^{18}O_{w}}{δ18Ow}, but with a multi–annual trend
#' in temperature superimposed on the seasonality.
#' 
#' Generated using the code in "Generate_Case12.r" in \code{data–raw}
#'
