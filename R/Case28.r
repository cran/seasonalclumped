...
#' and \code{3.25 mm}.
#' 
#' Case 28 describes an ideal temperature sinusoid without distortion by either
#' changes in growth rate or changes in \eqn{\delta^{18}O_{w}}{δ18Ow} but with a
#' shorter (1 yr) record length.
#' 
#' Generated using the code in "Generate_Case28.r" in \code{data–raw}
#'
